...
class WarriorTest {
    ...
    public final void Given_Warrior_When_CharacterClassAndSkillsSelected_Then_DisplayDescription() {
        ...
        assertEquals(warrior.toString(), "Wouarggg ! Je suis le Guerrier, Joueur 1, niveau 30, je possède 150 de vitalité, 10 de force, 12 d'agilité et 8 d'intelligence.");
    }
    ...
    public final void Given_Warrior_When_UseSpecialAttack_Then_InflictDamage() {
        ...
        Warrior opponent= new Warrior(2, 10, 12, 8);
        warrior.Opponent(opponent);
        assertEquals(warrior.combat(2), "Joueur 1 utilise Coup de rage, inflige 20 de dégâts et perd 5 de vitalité");
    }
}